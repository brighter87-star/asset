...
Usage:
    ...
    python scripts/init_database.py --drop-existing  # Drop tables first
"""
...
TABLES = {
    ...
    "account_summary": """
        CREATE TABLE IF NOT EXISTS account_summary (
            ...
            aset_evlt_amt BIGINT COMMENT '자산평가금액',
            tot_est_amt BIGINT COMMENT '총평가금액',
    ...
    "daily_portfolio_snapshot": """
        CREATE TABLE IF NOT EXISTS daily_portfolio_snapshot (
            snapshot_date DATE PRIMARY KEY COMMENT '스냅샷 일자',
            day_stk_asst BIGINT COMMENT '추정자산',
            tot_pur_amt BIGINT COMMENT '총매입금액',
...
# Order matters for dropping (due to potential foreign keys)
DROP_ORDER = [
    "portfolio_snapshot",
    "daily_lots",
    "holdings",
...
def main():
    parser = argparse.ArgumentParser(description="Initialize asset database tables")
    parser.add_argument(
        "--drop-existing",
        action="store_true",
