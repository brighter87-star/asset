...
def show_live_status(monitor: MonitorService, prices: dict, today_trades: list = None, holdings_prices: dict = None, clear: bool = True):
    ...
    # Check close logic timing (KRX 15:18-20 or NXT 19:58)
    ...
    print(f"Breakout: 8:00-8:02, 9:00-9:10, 14:30-15:18 | Close: 15:18-20(KRX), 19:58(NXT){active_marker}")
    print("=" * 74)
    ...
    if other_holdings:
        ...
        for pos in other_holdings:
            ...
            if entry > 0 and current > 0:
                ...
                return_pct = -999  # Put unknown at bottom
